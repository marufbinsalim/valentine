...
import { slides2026 } from "@/slides/2026";

export default function Home2026() {
    return (
        <div className="h-svh flex items-center justify-center relative overflow-clip">
            <StarsBackground
                starColor={'#FFF'}
                className={cn(
            ...
            {/* Slideshow layer */}
            <div className="absolute inset-0 z-50 h-svh w-svw">
                <Slideshow
                    slides={slides2026}
                />
            </div>
